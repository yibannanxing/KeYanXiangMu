        ...
        <div style="width:1002px;margin:0 auto;">
            ...
            <table align="center" style="border:1px solid rgba(220,220,226,1);width:1000px " ref="xiangmu" :model="xiangmu" :rules="rules">
                <tr style="text-align:center;" class="tbe">
                    ...
                    <td width="600px" colspan="9"><i-input v-model="xiangmu.xiangMuMingCheng" :maxlength="30" :disabled="isView" placeholder="请输入项目名称" size="large"></i-input></td>
                </tr>
                ...
                <tr style="text-align:center;" class="tbe">
                    ...
                    <td colspan="2" width="260px">
                        <i-input :disabled="isView" :maxlength="10" v-model="xiangmu.shenQingRenName" size="large"></i-input>
                    </td>
                    <td>性别</td>
                    <td>
                        ...
                        <!--<i-input :disabled="isView" v-model="xiangmu.xingBie" size="large" :maxlength="2"></i-input>-->
                    </td>
                    <td>民族</td>
                    <td width="100px">
                        <i-input :disabled="isView" v-model="xiangmu.minZu" size="large" :maxlength="7"></i-input>
                    </td>
                    <td width="100px">出生年月</td>
                    <td width="200px">
                        <DatePicker type="date" :disabled="isView" placeholder="选择日期" style="width: 200px" v-model="xiangmu.chuShengNianYue"></DatePicker>
                    </td>
                </tr>
                <tr style="text-align:center;" class="tbe">
                    <td width="200px">所属部门（教研室）</td>
                    <td width="100px" colspan="4">
                        <i-input :disabled="isView" v-model="xiangmu.shenQingRenBuMenMingCheng" size="large" :maxlength="10"></i-input>
                    </td>
                    <td width="100px">联系电话</td>
                    <td width="100px" colspan="4">
                        <i-input :disabled="isView"
                                 v-model="xiangmu.lianXiDianHua"
                                 number="true"
                                 placeholder="请输入电话号码"
                                 size="large"
                ...
                <tr style="text-align:center;" class="tbe">
                    <td width="200px">行政职务</td>
                    <td width="150px" colspan="2">
                        <i-input v-model="xiangmu.xingZhengZhiWu" :disabled="isView" placeholder="请输入行政职务" size="large" :maxlength="7"></i-input>
                    </td>
                    <td width="100px">教官职务</td>
                    <td width="100px" colspan="2">
                        <i-input v-model="xiangmu.jiaoGuanZhiWu" :disabled="isView" placeholder="请输入教官职务" size="large" :maxlength="7"></i-input>
                    </td>
                    <td width="100px">专技职务</td>
                    <td width="150px" colspan="2">
                        <i-input v-model="xiangmu.zhunJiZhiWu" :disabled="isView" placeholder="请输入专技职务" size="large" :maxlength="7"></i-input>
                    </td>
                </tr>


                <tr style="text-align:center;" class="tbe">
                    <td width="200px">为在校本科生授课科目</td>
                    <td width="200px" colspan="3">
                        <i-input v-model="xiangmu.shouKeKeMu" :disabled="isView" placeholder="请输入授课科目" size="large" :maxlength="7"></i-input>
                    </td>
                    <td width="100px">授课对象</td>
                    <td width="300px" colspan="2">
                        <i-input v-model="xiangmu.shouKeDuiXiang" :disabled="isView" placeholder="请输入授课对象" size="large" :maxlength="7"></i-input>
                    </td>
                    <td width="100px">最后学历</td>
                    <td width="100px" colspan="2">
                        <i-input v-model="xiangmu.zuiHouXueLi" :disabled="isView" placeholder="请输入学历" size="large" :maxlength="7"></i-input>
                    </td>
                </tr>
                <tr>
                    <td colspan="10" style="margin:0;padding:0;">
                        <span v-model="xiangmu.liXiangLeiXing" hidden="hidden"> </span>
                ...
                <tr>
                    ...
                    <td colspan="9" style="padding-left:10px">
                        <RadioGroup v-model="xiangmu.yuQiChengGuoLeiXing" style="margin-right:300px">
            ...
            <Form ref="xiangmu.xiangMuFangAn" :model="xiangmu.xiangMuFangAn" style="width:1045px">
                <FormItem label=" " prop="xiangMuChengGuo">
                    <i-input v-model="xiangmu.xiangMuFangAn.xiangMuChengGuo" 
                             ...
                             :rows="5" 
                             :maxlength="100" 
                             placeholder="研究成果将应用于何处？将有怎样的应用的价值？限100字" />
                </FormItem>
            </Form>
            ...
            <Form ref="xiangmu.xiangMuFangAn" :model="xiangmu.xiangMuFangAn">
                <FormItem label="1、选题" prop="xiangMuXuanTi" style="width:1045px">
                    <i-input v-model="xiangmu.xiangMuFangAn.xiangMuXuanTi" 
                             ...
                             :rows="12" 
                             :maxlength="1000" 
                             placeholder="国内外研究现状述评，选题意义和价值（最少500字）" />
                </FormItem>
                <FormItem label="2、方案" 
                          prop="xiangMuFangAn1" 
                          style="width:1045px">
                    <i-input v-model="xiangmu.xiangMuFangAn.xiangMuFangAn1" 
                             ...
                             :rows="12" 
                             :maxlength="2000" 
                             placeholder="项目研究的主要内容、研究难点、拟创新点、研究方法、研究步骤（主要阶段性成果 1000-2000字）。" />
                </FormItem>
                <FormItem label="3、研究基础" prop="yanJiuJiChu" style="width:1045px">
                    <i-input v-model="xiangmu.xiangMuFangAn.yanJiuJiChu" 
                             ...
                             :rows="12" 
                             :maxlength="1000" 
                             placeholder="研究人员自身已有的相关成果、主要参考文献（限填20项 500-1000字）。" />
                </FormItem>
            </Form>
            ...
            <jingfeilist :isView="isView" 
                         ...
                         v-model="xiangmu.jingFeis" ></jingfeilist>

            <i-button @click="save" 
                      style="width:200px;margin:0 400px" 
                      v-if="!isView" type="primary">保存</i-button>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                if (this.xiangmu.xiangMuMingCheng == undefined || this.xiangmu.xiangMuMingCheng == null || this.xiangmu.xiangMuMingCheng.length==0) {
                ...
                } else if (this.xiangmu.shenQingRenBuMenMingCheng == undefined || this.xiangmu.shenQingRenBuMenMingCheng == null) {
                    this.$Message.error('部门不能为空');
                } else if (!(/^[1][3,4,5,7,8][0-9]{9}$/).test(this.xiangmu.lianXiDianHua)) {
