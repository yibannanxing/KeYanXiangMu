    ...
    <div style="padding:10px;text-align:center">
        <table align="center" style="width:1000px" v-model="jiexiang">
            <tr class="tbe">
                ...
                <td>所属专业</td>
                <td>
                    <i-input v-model="jiexiang.zuanyYe" :disabled="isView" :maxlength="20" size="large"></i-input>
                </td>
                <td>联系电话</td>
                <td>
                    <i-input v-model="jiexiang.dianHua" :disabled="isView" :maxlength="11" size="large"></i-input>
                </td>
            </tr>
            <!--结项项目组成员-->
            <tr class="tbe">
            ...
            <tr class="tbe">
                ...
                <td colspan="5">
                    <i-input v-model="jiexiang.zuiZhongChengGuoZiShu"  :disabled="isView" size="large" placeholder="单位（千字）"></i-input>
                </td>
            </tr>
            <tr class="tbe">
            ...
            <tr class="tbe">
                ...
                <td>核准经费</td>
                <td>
                    <i-input v-model="jiexiang.heZunJingFei" :maxlength="10" :disabled="isView" size="large" placeholder="万元"></i-input>
                </td>

                <td>实际使用经费</td>
                <td>
                    <!--jiexiang.shiJiJingFei-->
                    <i-input v-model="sjjf" :maxlength="10" :disabled="isView" size="large" placeholder="万元"></i-input>
                </td>

                <td>结余</td>
                <td>
                    <!--jiexiang.jieYu-->
                    <i-input v-model="jieyu" :maxlength="10" :disabled="isView" size="large" placeholder="万元"></i-input>
                </td>
            </tr>
            <tr class="tbe">
                <td>经费开支名称</td>
            ...
            <tr class="tbe">
                <td>资料费</td>
                <td>
                    <i-input v-model="jxjingfeis.ziliaofei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>调研差旅费</td>
                <td>
                    <i-input v-model="jxjingfeis.diaoyanchailvfei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>材料费</td>
                <td>
                    <i-input v-model="jxjingfeis.cailiaofei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>制作费</td>
                <td>
                    <i-input v-model="jxjingfeis.zhizuofei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>软件开发费</td>
                <td>
                    <i-input v-model="jxjingfeis.ruanjiankaifafei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>咨询费</td>
                <td>
                    <i-input v-model="jxjingfeis.zixunfei" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
            ...
            <tr class="tbe">
                <td>其他</td>
                <td>
                    <i-input v-model="jxjingfeis.qita" :maxlength="10" :disabled="isView" size="large"></i-input>
                </td>
                <td colspan="4">
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                } else if (this.jiexiang.zuanyYe == null || this.jiexiang.zuanyYe == undefined || this.jiexiang.zuanyYe.length == 0 ) {
                    this.$Message.error('请填写所属专业');
                } else if (this.jiexiang.dianHua == null || this.jiexiang.dianHua == undefined || this.jiexiang.dianHua.length == 0) {
                    this.$Message.error('请填写电话号码');
                } else if (!(/^[1][3,4,5,7,8][0-9]{9}$/).test(this.jiexiang.dianHua)) {
